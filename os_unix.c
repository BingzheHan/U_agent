...
#ifdef CONFIG_HS20_SAMSUNG_TEMP_CRED_FILE
	//read for internal memory
	gid_t groups[] = { AID_INET, AID_WIFI, AID_KEYSTORE ,AID_SDCARD_RW ,AID_SHELL, AID_SDCARD_R };
#elif ANDROID_SETGROUPS_OVERRIDE
