...
#ifdef CONFIG_GB2312
#define GB_FLAG 0x01
#define GB_CHART_SET "GB2312"
#define MAX_SSID_UTF16_CHAR_NUM 32
#define MAX_SSID_GB_BUF_LEN (MAX_SSID_UTF16_CHAR_NUM *4)  //a gbk character has 4 bytes for max
#define MAX_SSID_UTF8_BUF_LEN MAX_SSID_GB_BUF_LEN
int check_gb2312_change_utf8(char *io_str_buf, int *io_str_len);
int check_utf8_change_gb2312(char *io_str_buf, int *io_str_len);
#endif
